...
const myInformation = ["Татьяна", 25, 3, "Овен"];
...
const countriesLess = countries.shift();
console.log(countriesLess);
...
let russianCities2 = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
...
function numberSumm() {
    ...
    let numberSum = (numbers[0]) + (numbers.length);
    return numberSum;
}
...
const filterEvenNumbers = () => numbers.filter(x => x % 2 === 0);
